...
func initPolicy(t *testing.T, driverName string, dataSourceName string, dbSpecified ...bool) {
	...
	log.Println("Casbin Policy: ", e.GetAllActions())
	...
	if err != nil {
		log.Println("SavePolicy Error: ", err)
		panic(err)
	}
...
func TestAdapters(t *testing.T) {
	...
	testSaveLoad(t, "postgres", "dbname=postgres user=vinayams host=127.0.0.1 port=5432 sslmode=disable", true)
	testAutoSave(t, "postgres", "dbname=postgres user=vinayams host=127.0.0.1 port=5432 sslmode=disable", true)

	//Does not work if DB name is not specified.
	//testSaveLoad(t, "postgres", "user=vinayams host=127.0.0.1 port=5432 sslmode=disable")
	//testAutoSave(t, "postgres", "user=vinayams host=127.0.0.1 port=5432 sslmode=disable")
